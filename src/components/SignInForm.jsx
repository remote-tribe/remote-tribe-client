			...
			<div className='mx-auto flex flex-col items-center  px-6 md:h-full lg:py-0'>
				...
				<div className='w-full rounded-lg bg-white shadow dark:border dark:border-gray-700 dark:bg-gray-800 sm:max-w-md md:mt-0 xl:p-0 '>
					<div className='space-y-4 p-6 sm:p-8 md:space-y-6'>
						<h1 className='mb-8 text-center text-xl font-semibold leading-tight tracking-tight text-gray-900 dark:text-white md:text-2xl'>
						...
						<form
							...
							<div>
								...
								<input
									...
									border border-gray-300 bg-gray-50 p-2.5 text-gray-900 outline-none ring-sky-400	transition-all duration-150 focus:shadow-md focus:ring-2 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:ring-sky-500 sm:text-sm'
								/>
							</div>
							<div>
								<label
							...
							<div className='flex items-center justify-between'>
								<div className='flex items-start'>
									<div className='flex h-5 items-center'>
										<input
											...
											className='focus:ring-3 focus:ring-primary-300 dark:focus:ring-primary-600 h-4 w-4 cursor-pointer rounded border border-gray-300
                                     bg-gray-50 accent-sky-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800'
										/>
									</div>
								...
								<Link
									...
									to={'#'}
									className='text-primary-600 dark:text-primary-500 text-sm font-medium text-sky-500  hover:text-sky-600'>
									Forgot password?
								</Link>
							</div>
							{isLoading ? (
							...
							<div className='button-div'>
								<button
									type='submit'
									className='dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 mx-auto flex w-auto rounded-lg border border-sky-500 px-6 py-1 text-center text-xl font-medium text-sky-500 transition-all duration-300 hover:-translate-y-0.5 hover:border-sky-400 hover:text-sky-300 hover:shadow-lg'>
									Sign In
								</button>
							</div>
